...
parser.add_argument('--weight', type=str, default='output/weights_a100/mask45_patch4.pth', help='weight')
...
def inference(args, model, test_save_path=None):
    db_test = AcdcDataset(args.volume_path,args.list_dir,transform=transforms.Compose([RandomGenerator(output_size=[args.img_size, args.img_size])]))
